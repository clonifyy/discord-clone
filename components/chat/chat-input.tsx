          ...
          <FormItem>
            <FormControl>
              <div className='relative p-4 pb-6'>
                <button onClick={() => onOpen('messageFile', { apiUrl, query })} className='bg-zinc-500 dark:bg-zinc-400 hover:bg-zinc-600 dark:hover:bg-zinc-300 transition rounded-full p-1 flex items-center justify-center absolute top-7 left-8 h-[24px] w-[24px]' type='button'>
